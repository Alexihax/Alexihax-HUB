...
--! configuration
local service = 25623;  -- your service id, this is used to identify your service.
local secret = "3d9cb4b7-42c5-4612-9d46-4086b3956a8e";  -- make sure to obfuscate this if you want to ensure security.
...
pcall(function()
    CoreGui:FindFirstChild("AlexihaxLoader"):Destroy()
end)

local gui = Instance.new("ScreenGui")
gui.Name = "AlexihaxLoader"
...
verify.Position = UDim2.new(0.075,0,0.58,0)
verify.Text = "Verify Key"
verify.TextScaled = true
verify.Font = Enum.Font.GothamBold
verify.TextColor3 = Color3.new(1,1,1)
verify.BackgroundColor3 = Color3.fromRGB(255,120,0)
...
getKey.BackgroundColor3 = Color3.fromRGB(45,45,60)
